...
search.addEventListener('keyup',(e)=>{
  ...
  const filterProducts=data.filter((pro)=>pro.names.toLocaleLowerCase().includes(searchData)|| pro.brand.toLocaleLowerCase().includes(searchData)||pro.category.toLowerCase().includes(searchData));
